...
public class ChangeRoleResource {
    ...
    public Response changeRole(Map<String, Object> request, @Context HttpHeaders headers) {
        ...
        String usernameToChange = (String) input.get("userId");
        String newRole = (String) input.get("newRole");

        Map<String, Object> result = userService.changeUserRole(userInfo[0], userInfo[1], usernameToChange, newRole);
