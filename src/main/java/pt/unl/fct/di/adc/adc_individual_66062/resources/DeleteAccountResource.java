...
public class DeleteAccountResource {
    ...
    public Response deleteAccount(Map<String, Object> request, @Context HttpHeaders headers) {
        ...
        String usernameToDelete = (String) input.get("username");

        Map<String, Object> result = userService.deleteAccount(userInfo[0], userInfo[1], usernameToDelete);
